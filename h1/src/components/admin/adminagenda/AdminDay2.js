...
export default class AdminDay2 extends Component {
    render() {
        return (
                        ...
                        <div id="dataTable_wrapper" className="dataTables_wrapper dt-bootstrap4">
                            <div className="row">
                                ...
                                <div className=" col-sm-12 col-md-6">
                                    ...
                                    <NavLink className="btn btn-primary col-lg-3 btn" to="/admin/admin-agenda/day2" style={{margin:'0 10px'}}>New day 2</NavLink>

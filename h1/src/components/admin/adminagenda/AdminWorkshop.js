...
export default class AdminWorkshop extends Component {
    render() {
        return (
                            ...
                            <div className="row">
                                ...
                                <div className=" col-sm-12 col-md-6">
                                    <div id="dataTable_filter" className="row dataTables_filter">
                                        {/* <NavLink className="btn btn-primary col-lg-3 btn-vy" to="/admin/admin-products/new-products" style={{marginRight: '20px'}} >New Product</NavLink> */}
                                        <NavLink className="btn btn-primary col-lg-3 btn" to="/admin/admin-agenda/workshops/new-workshop" style={{margin:'0 10px'}}>New workshop</NavLink>
